    ...
    <Card>
      <StyledDetailsSpace direction="vertical" size="middle">
        ...
        <Typography.Text>
          ...
          learned a lot and expanded my skill set. I became a fan of Typescript.
          I dived also into UX/UI design and provided high-quality sketches
          using Figma. Clean code and keeping code conventions is on my priority
          list.
        </Typography.Text>
        <Typography.Text>
          ...
          requirements but also the product itself and the idea behind it. I
          like to work on projects that are interesting for me. Working with
          people with whom I can build a great team is a big asset.
        </Typography.Text>
        <Typography.Text>
          ...
          environments. This helps me to communicate effectively with other
          people and to be seen by others as a great team member with a smile as
          a trademark. <SmileOutlined />
        </Typography.Text>
        <Typography.Text>
          ...
          distances of 5&#8288;&#8211;&#8288;15 km, but sometimes 21 km is not
          enough. Maybe one day, I'll start running marathons...
          <br />
